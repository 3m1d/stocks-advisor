...
class StocksParser:
    ...
    USDRUBF_TICKER = 'USDRUBF'
    EURRUBF_TICKER = 'EURRUBF'
    CNYRUBF_TICKER = 'CNYRUBF'
    IMOEX_TICKER = 'IMOEX'
    ...
    async def parse_stocks(self):
        return await self.moex_client.get_data(
            tickers=[self.GASP_TICKER, self.ROSN_TICKER, self.LKOH_TICKER, self.SBER_TICKER],
    ...
    async def parse_currencies(self):
        return await self.moex_client.get_data(
            tickers=[self.USDRUBF_TICKER, self.EURRUBF_TICKER, self.CNYRUBF_TICKER],
